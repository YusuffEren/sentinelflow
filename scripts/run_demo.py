...
TURKISH_CITIES = [
    ...
    "Kayseri", "Eskişehir", "Samsun", "Trabzon", "Denizli"
]

# Suspicious keywords for blacklist detection
SUSPICIOUS_KEYWORDS = [
    "komisyon", "ödül", "casino", "bahis", "yurtdışı transfer",
    "acil", "kara para", "kaçak"
]
...
def generate_transaction(is_fraud: bool = False) -> dict[str, Any]:
    ...
    if is_fraud:
        ...
        fraud_type = random.choice([
            "high_amount", "suspicious_desc", "odd_hour", "velocity"
        ])
...
def run_demo_producer(
    ...
    logger.info(f"Starting demo producer: {transactions_per_second} TPS, {fraud_rate*100:.1f}% fraud")
