...
def train_and_evaluate(
    ...
    results["models"]["IsolationForest"] = evaluate_model("IsolationForest", if_scores, if_preds, y_test)
    ...
    results["models"]["Ensemble"] = evaluate_model("Ensemble", ensemble_scores, ensemble_preds, y_test)
...
def print_report(results: dict) -> None:
    ...
    header = f"{'Model':<20} {'Accuracy':>10} {'Precision':>10} {'Recall':>8} {'F1':>8} {'AUC-ROC':>9}"
    print(header)
    print("-" * 70)
    ...
    if "true_positives" in best:
        ...
        print(f"  {'Actual Normal':15} {best['true_negatives']:>16,}  {best['false_positives']:>15,}")
        print(f"  {'Actual Fraud':15} {best['false_negatives']:>16,}  {best['true_positives']:>15,}")
    print()
