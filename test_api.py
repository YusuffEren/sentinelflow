...
# 3. Fraud transaction
res = post("/api/v1/transactions", {
    "sender_iban": "TR33000610", "sender_name": "Test",
    "sender_city": "Istanbul", "receiver_iban": "TR11000640",
    "receiver_name": "Alici", "receiver_city": "Ankara",
    "amount": 250000, "description": "bitcoin acil transfer"
})
print(f"FRAUD TX: is_fraud={res['is_fraud']}, score={res['fraud_score']}")

# 4. Clean transaction
res2 = post("/api/v1/transactions", {
    "sender_iban": "TR33000610", "sender_name": "Ali",
    "sender_city": "Istanbul", "receiver_iban": "TR11000640",
    "receiver_name": "Veli", "receiver_city": "Istanbul",
    "amount": 500, "description": "kira odemesi"
})
