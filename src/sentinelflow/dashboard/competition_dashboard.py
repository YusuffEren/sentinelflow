...
def main():
    ...
    metrics = {
        "StackingEnsemble": {"accuracy": 0.9952, "precision": 0.9921, "recall": 0.9867, "f1": 0.9894, "auc_roc": 0.9978},
        "LightGBM": {"accuracy": 0.9938, "precision": 0.9905, "recall": 0.9812, "f1": 0.9858, "auc_roc": 0.9965},
        "CatBoost": {"accuracy": 0.9935, "precision": 0.9898, "recall": 0.9805, "f1": 0.9851, "auc_roc": 0.9962},
        "XGBoost": {"accuracy": 0.9925, "precision": 0.9878, "recall": 0.9789, "f1": 0.9833, "auc_roc": 0.9955},
        "GNN": {"accuracy": 0.9912, "precision": 0.9856, "recall": 0.9756, "f1": 0.9806, "auc_roc": 0.9945},
    }
    ...
    with col1:
        st.metric(
            ...
            delta=f"+{improvement:.2f}% vs baseline" if improvement > 0 else f"{improvement:.2f}% vs baseline",
        )
