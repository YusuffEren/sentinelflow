...
SUSPICIOUS_KEYWORDS: list[str] = [
    ...
    # Cryptocurrency
    "kripto", "bitcoin", "btc", "ethereum", "usdt", "binance", "tether",
    # Anonymity / Evasion
    "offshore", "anonim", "gizli", "anonymous", "proxy", "vpn",
    # Urgency
    "acil", "urgent", "hemen", "immediately",
    # Money laundering
    "yıkama", "laundering", "temizleme", "aklama",
]
    ...
    def extract(self, tx_data: dict[str, Any]) -> dict[str, float]:
        ...
        if sender_coords and receiver_coords:
            features["city_distance_km"] = self._haversine(
                sender_coords[0], sender_coords[1],
