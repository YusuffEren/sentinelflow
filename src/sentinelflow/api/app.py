...
class AppState:
    ...
    def load_ml_components(self) -> bool:
        ...
        try:
            ...
            if_model = IsolationForestModel(contamination=0.05, n_estimators=200, min_samples_to_train=50)
...
async def system_stats() -> StatsResponse:
    ...
    fraud_rate = (state.fraud_detected / state.transactions_processed * 100) if state.transactions_processed > 0 else 0.0
