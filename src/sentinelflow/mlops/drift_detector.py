...
class DriftDetector:
    ...
    def detect_model_drift(
        ...
        for metric, ref_value in reference_metrics.items():
            ...
            # Check threshold
            threshold = metric_thresholds.get(metric, self._metric_threshold) if metric_thresholds else self._metric_threshold
        ...
        logger.info(f"Model drift analysis complete: has_drift={report.has_drift}, severity={report.severity.value}")
