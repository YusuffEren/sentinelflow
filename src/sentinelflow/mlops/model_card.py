...
class ModelCard:
    ...
    def to_markdown(self, filepath: Optional[str] = None) -> str:
        ...
        # Footer
        md.append("---")
        md.append(f"*Generated by SentinelFlow MLOps on {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}*")
...
def generate_model_card(
    ...
    if training_data is not None:
        ...
        card.training_motivation = "Representative sample of financial transactions including labeled fraud cases"
